# src/train_code_to_pseudocode.py
...
class CodeToPseudoDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Add <sos> and <eos> to target (pseudocode)
...
def main():
    ...
    parser.add_argument('--pairs_file', type=str, required=True,
                        help='Path to train_pairs_code_to_pseudocode.txt')
    ...
    dataset = CodeToPseudoDataset(args.pairs_file, src_vocab, tgt_vocab, max_len=args.max_len)
    ...
    torch.save(model.state_dict(), "transformer_code_to_pseudocode.pt")
    print("Model saved as transformer_code_to_pseudocode.pt")
